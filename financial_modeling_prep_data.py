...
def save_stock_market_caps_to_csv(tickers,
    ...
    for index, ticker in enumerate(tickers, start = 1):
        ...
        url = f"https://financialmodelingprep.com/api/v3/historical-market-capitalization/{ticker}?limit=10000&apikey={key}"
        ...
        if not stock_market_cap_data.empty:
            ...
            stock_market_cap_data.to_csv(os.path.join('./stock_market_caps_test', f'{ticker}.csv'))
        else:
